...
CREATE TABLE LICHCHIEU(
	...
	CaXC INT REFERENCES XUATCHIEU(MaXC),
	MaPC INT REFERENCES PHONGCHIEU(MaPC),
	MaPhim INT REFERENCES PHIM(MaPhim)
)
...
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 1', 3, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 5, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 5', 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 4, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 4', 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 3, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 3', 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 2, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 2', 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 1, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231023', 'ENABLE', 0, 'CA 1', 4, 1)

--Truy xuất lịch chiếu theo mã phim
SELECT DISTINCT XUATCHIEU.GioXC FROM LICHCHIEU, PHONGCHIEU, LOAIPC, XUATCHIEU WHERE MaPhim = 1 AND LOAIPC.TenLPC = '2D' AND XUATCHIEU.CaXC = LICHCHIEU.CaXC AND LICHCHIEU.MaPC = PHONGCHIEU.MaPC AND PHONGCHIEU.MaLPC = LOAIPC.MaLPC AND LICHCHIEU.NgayLC = '2023-10-20' ORDER BY GioXC ASC

SELECT DISTINCT XUATCHIEU.GioXC FROM LICHCHIEU, PHONGCHIEU, LOAIPC, XUATCHIEU WHERE MaPhim = 1 AND LOAIPC.TenLPC = '3D' AND XUATCHIEU.CaXC = LICHCHIEU.CaXC AND LICHCHIEU.MaPC = PHONGCHIEU.MaPC AND PHONGCHIEU.MaLPC = LOAIPC.MaLPC AND LICHCHIEU.NgayLC = '2023-10-20' ORDER BY GioXC ASC
...
SELECT* FROM LOAIPC
SELECT* FROM LICHCHIEU ORDER BY MaPhim asc, CaXC asc, MaPC asc
...
SELECT LICHCHIEU.*, PHONGCHIEU.SLGheThuong, PHONGCHIEU.SLGheVIP FROM LICHCHIEU, XUATCHIEU, PHIM, PHONGCHIEU, LOAIPC WHERE LOAIPC.TenLPC = '2D' AND LOAIPC.MaLPC = PHONGCHIEU.MaLPC AND PHONGCHIEU.MaPC = LICHCHIEU.MaPC AND PHIM.MaPhim = LICHCHIEU.MaPhim AND LICHCHIEU.CaXC = XUATCHIEU.CaXC AND LICHCHIEU.NgayLC = '2023-10-23' AND LICHCHIEU.MaPhim = 1 AND XUATCHIEU.GioXC = '7:00:00'
