...
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 4, 11)
--Thêm lịch chiếu cho ÁNH SÁNG ĐEN TỐI
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 1, 12)
--Thêm lịch chiếu cho CỔNG TRUY CẬP HUYỀN BÍ
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 1, 13)
--Thêm lịch chiếu cho THỊ TRẤN ÁM ẢNH
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 1, 14)
--Thêm lịch chiếu cho CUỘC CHIẾN ẨN DANH
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 1, 15)
--Thêm lịch chiếu cho BIỆT ĐỘI SỨ GIẢ
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 1, 16)
--Thêm lịch chiếu cho BÓNG ĐÊM KHIẾN ÁM ẢNH
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 2, 17)
--Thêm lịch chiếu cho THÀNH PHỐ ÁM ẢNH
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 2, 18)
--Thêm lịch chiếu cho TÀN TÍCH CỦA QUỶ
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 2, 19)
--Thêm lịch chiếu cho HUYỀN BÍ SÂN CHƠI
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 2, 20)
--Thêm lịch chiếu cho CUỘC CHIẾN TRONG BÓNG TỐI
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 2, 21)
--Thêm lịch chiếu cho CUỘC SỐNG TRONG HUYỀN BÍ
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 3, 22)
--Thêm lịch chiếu cho THÀNH PHỐ ĐEN TỐI
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 3, 23)
--Thêm lịch chiếu cho CUỘC SỐNG TRONG BÓNG TỐI
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 3, 24)
--Thêm lịch chiếu cho CUỘC CHIẾN TRONG BÓNG ĐÊM
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 3, 25)
--Thêm lịch chiếu cho ĐƯỜNG HUYỀN BÍ
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 4, 26)
--Thêm lịch chiếu cho CUỘC CHIẾN ẨN DANH II
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 4, 27)
--Thêm lịch chiếu cho BÓNG TỐI KÝ ỨC
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 4, 28)
--Thêm lịch chiếu cho KHO BÁU TRONG RỪNG SÂU
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 1, 4, 29)
--Thêm lịch chiếu cho ÁN MẠNG Ở VENICE
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 1, 30)
--Thêm lịch chiếu cho THE NUN
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 1, 31)
--Thêm lịch chiếu cho BIỆT ĐỘI ĐÁNH THUÊ 4
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 1, 32)
--Thêm lịch chiếu cho HỌA QỦY
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 1, 33)
--Thêm lịch chiếu cho NHÂN DUYÊN TIỀN ĐÌNH
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 2, 34)
--Thêm lịch chiếu cho LIVE - #pháttrựctiếp
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 2, 35)
--Thêm lịch chiếu cho THE NUN II
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 2, 36)
--Thêm lịch chiếu cho ĐẤT RỪNG PHƯƠNG NAM
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 2, 37)
--Thêm lịch chiếu cho ARGYLLE SIÊU ĐIỆP VIÊN
INSERT INTO LICHCHIEU VALUES(GETDATE(), 'ENABLE', 0, 2, 2, 38)
