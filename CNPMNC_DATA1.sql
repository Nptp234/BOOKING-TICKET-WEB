...
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 1, 1, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 2, Phòng 1(2D), Mã phim 2
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 2, 1, 2)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 3, Phòng 1(2D), Mã phim 3
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 3, 1, 3)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 4, Phòng 1(2D), Mã phim 4
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 4, 1, 4)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 5, Phòng 1(2D), Mã phim 5
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 5, 1, 5)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 1, Phòng 2(3D), Mã phim 6
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 1, 2, 6)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 2, Phòng 2(3D), Mã phim 7
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 2, 2, 7)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 3, Phòng 2(3D), Mã phim 8
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 3, 2, 8)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 4, Phòng 2(3D), Mã phim 9
INSERT INTO LICHCHIEU VALUES('20231020', 'ENABLE', 0, 4, 2, 9)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 5, Phòng 2(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 5, 2, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 5, Phòng 3(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 5, 3, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 5, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 5, 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 4, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 4, 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 3, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 3, 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 2, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 3, 4, 1)
--Thêm LICHCHIEU vào ngày 20-10-2023, 'ENABLE', số vé là 0, Ca chiếu 1, Phòng 4(3D), Mã phim 1
INSERT INTO LICHCHIEU VALUES('20231022', 'ENABLE', 0, 1, 4, 1)

--Truy xuất lịch chiếu theo mã phim
SELECT DISTINCT XUATCHIEU.GioXC FROM LICHCHIEU, PHONGCHIEU, LOAIPC, XUATCHIEU WHERE MaPhim = 1 AND LOAIPC.TenLPC = '2D' AND XUATCHIEU.MaXC = LICHCHIEU.CaXC AND LICHCHIEU.MaPC = PHONGCHIEU.MaPC AND PHONGCHIEU.MaLPC = LOAIPC.MaLPC AND LICHCHIEU.NgayLC = '2023-10-20' ORDER BY GioXC ASC
SELECT DISTINCT XUATCHIEU.GioXC FROM LICHCHIEU, PHONGCHIEU, LOAIPC, XUATCHIEU WHERE MaPhim = 1 AND LOAIPC.TenLPC = '3D' AND XUATCHIEU.MaXC = LICHCHIEU.CaXC AND LICHCHIEU.MaPC = PHONGCHIEU.MaPC AND PHONGCHIEU.MaLPC = LOAIPC.MaLPC AND LICHCHIEU.NgayLC = '2023-10-20' ORDER BY GioXC ASC


SELECT PHIM.*, GIOIHANTUOI.MoTaGHT, GIOIHANTUOI.TenGHT FROM PHIM, GIOIHANTUOI WHERE MaPhim = 1 AND GIOIHANTUOI.MaGHT = PHIM.MaGHT

SELECT THELOAIP.MoTaTL, THELOAIP.TenTL FROM THELOAIP, TL_P WHERE THELOAIP.MaTL = TL_P.MaTL AND TL_P.MaPhim = 1

--Insert account mẫu

INSERT INTO LOAIKH VALUES (N'KHÁCH HÀNG', 0.0)
INSERT INTO KHACHHANG VALUES ('demo_khachhang', '123456', 'dfzdfg@gmail.com', 0, 'ACTIVE', 1);

INSERT INTO VEPHIM VALUES (GETDATE(), N'CHƯA THANH TOÁN', 'CHƯA HẾT HẠN', 6, 6*50000, 1, 1);

INSERT INTO VE_GHE VALUES (1, 'C1')
INSERT INTO VE_GHE VALUES (1, 'C2')
INSERT INTO VE_GHE VALUES (1, 'C3')
INSERT INTO VE_GHE VALUES (1, 'C4')
INSERT INTO VE_GHE VALUES (1, 'C5')
INSERT INTO VE_GHE VALUES (1, 'C6')
